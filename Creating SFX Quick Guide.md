...
I absolutely do not understand all of it but there are [people who do](https://www.youtube.com/watch?v=1aSAqWgtrD0). You're essentially using the values on the left to manipulate the waveform on the right to make waveform shapes. You can probably look up some shapes for various sounds, but I dont personally find this channel particularly useful for anything other than music. 
