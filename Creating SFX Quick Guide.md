...
You will then need to put these into the plugin formatted like below. Be sure to rename the event so you know what sound it is. For more info on the plugin, check out the guide</br>
